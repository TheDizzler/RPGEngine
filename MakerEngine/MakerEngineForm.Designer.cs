namespace MakerEngine {
	partial class MakerEngineForm {
		...
		private void InitializeComponent() {
			...
			this.button_ConvertTMX.Click += new System.EventHandler(this.button_ConvertTMX_Click);
			// 
			...
			this.tableLayoutPanel_TMXData.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle());
			this.tableLayoutPanel_TMXData.Controls.Add(this.textBox_MapName, 1, 0);
			...
			// textBox_MapName
			// 
			this.textBox_MapName.Dock = System.Windows.Forms.DockStyle.Fill;
			this.textBox_MapName.Location = new System.Drawing.Point(96, 6);
			this.textBox_MapName.Name = "textBox_MapName";
			this.textBox_MapName.ReadOnly = true;
			this.textBox_MapName.Size = new System.Drawing.Size(192, 20);
			...
			this.pictureBox_Map.Size = new System.Drawing.Size(733, 408);
			...
			// 
			this.splitContainer_MapTools.Panel2.Controls.Add(this.tabControl_ImageViewer);
			...
			// 
			this.tabControl_ImageViewer.Controls.Add(this.tabPage1);
			this.tabControl_ImageViewer.Dock = System.Windows.Forms.DockStyle.Fill;
			this.tabControl_ImageViewer.Location = new System.Drawing.Point(0, 0);
			this.tabControl_ImageViewer.Name = "tabControl_ImageViewer";
			this.tabControl_ImageViewer.SelectedIndex = 0;
			this.tabControl_ImageViewer.Size = new System.Drawing.Size(325, 290);
			this.tabControl_ImageViewer.TabIndex = 0;
			// 
			// tabPage1
			// 
			...
			this.contextMenuStrip_ZoneText.Size = new System.Drawing.Size(168, 92);
			// 
			...
			this.newTriggeredEventToolStripMenuItem.Click += new System.EventHandler(this.newTriggeredEventToolStripMenuItem_Click);
			// 
			...
			this.deleteTriggeredEventToolStripMenuItem.Click += new System.EventHandler(this.deleteTriggeredEventToolStripMenuItem_Click);
			// 
			// imageTMXList
			// 
			this.imageTMXList.ColorDepth = System.Windows.Forms.ColorDepth.Depth8Bit;
			this.imageTMXList.ImageSize = new System.Drawing.Size(32, 32);
			this.imageTMXList.TransparentColor = System.Drawing.Color.Transparent;
			// 
    ...
    "f|JPG|*.jpg;*.jpeg|PNG|*.png|TIFF|*.tif;*.tiff|DDS|*.dds";
			...
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.MakerEngineForm_FormClosing);
		...
		private System.Windows.Forms.ImageList imageTMXList;
